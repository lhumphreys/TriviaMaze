...
public class MyQuery
{
	...
	public String printAllQuestions()throws SQLException
	{
		System.out.println();
		...
		while (rs.next())
		{
			...
			result = result + qNum + " " + question + " " + qType + "\n";
	...
	public String printAllAnswers()throws SQLException
	{
		System.out.println();
		...
		while (rs.next())
		{
			...
			result = result + qNum + " " + aNum + " " + correct + " " + answer + "\n";
			//System.out.printf("%-5s %-5s %-8s %-150s\n", qNum, aNum, correct, answer);
		}
		return result;
	}
	...
	public Question getQuestion(int newQNum)throws SQLException
	{
